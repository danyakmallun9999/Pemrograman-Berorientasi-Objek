  ...
  nilaiUas = int.parse(inputNilaiUAS!);
    ...
    // jika nilai tugas >= 90 && nilai uts >= 90 && nilai uas >= 90
      if ( nilaiTugas >= 90 && nilaiUts >= 90 && nilaiUas >= 90 ) {
        // lulus dengan baik
        dataMahasiswa(namaMhs, prodiMhs, nilaiTugas, nilaiUts, nilaiUas, tingkahLaku);
...
// data mahasiswa
void dataMahasiswa (namaMhs, prodiMhs, nilaiTugas, nilaiUts, nilaiUas, tingkahLaku) {
